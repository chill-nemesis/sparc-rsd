...
You can also run each exercise with the `--solution` flag to see the implemented solution in action.
...
1. Ensure you have a (relatively) recent version of Python installed. The exercises have been developed and tested using Python 3.11.9 and 3.12.
